...
public:
    ...
    id from_table(TableRef v) { return box(std::move(v)); }
...
template<>
Timestamp RLMAccessorContext::unbox(id v) { return RLMTimestampForNSDate(v); }
template<>
bool RLMAccessorContext::unbox(id v) { return [v boolValue]; }
template<>
double RLMAccessorContext::unbox(id v) { return [v doubleValue]; }
template<>
float RLMAccessorContext::unbox(id v) { return [v floatValue]; }
template<>
long long RLMAccessorContext::unbox(id v) { return [v longLongValue]; }
template<>
BinaryData RLMAccessorContext::unbox(id v) { return RLMBinaryDataForNSData(v); }
template<>
StringData RLMAccessorContext::unbox(id v) { return RLMStringDataWithNSString(v); }
template<>
realm::util::Optional<bool> RLMAccessorContext::unbox(id v) { return v ? realm::util::Optional<bool>([v boolValue]) : util::none; }
template<>
realm::util::Optional<double> RLMAccessorContext::unbox(id v) { return v ? realm::util::make_optional([v doubleValue]) : util::none; }
template<>
realm::util::Optional<float> RLMAccessorContext::unbox(id v) { return v ? realm::util::make_optional([v floatValue]) : util::none; }
template<>
realm::util::Optional<int64_t> RLMAccessorContext::unbox(id v) { return v ? realm::util::make_optional([v longLongValue]) : util::none; }
